...
<section class="section-content" style="margin: 100px 0;">
  <div class="card mx-auto" style="max-width: 380px">
    <div class="card-body">
      ...
      <c:if test="${not empty requestScope.errorMessage}">
       ...
       <h4 class="card-title text-center text-primary mb-4">Đăng ký</h4> 
  ...
  <p class="text-center mt-3">Đã có tài khoản? <a href="${pageContext.request.contextPath}/signin">Đăng nhập</a></p>
