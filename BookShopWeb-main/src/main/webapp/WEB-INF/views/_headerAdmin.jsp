      ...
      <div class="row align-items-center">
        ...
        <div class="col-sm-1">
          <ul class="nav col-12 col-lg-auto my-2 my-lg-0 justify-content-center justify-content-lg-end text-small">
            <li>
              <a href="${pageContext.request.contextPath}/" class="nav-link text-white" target="_blank">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <c:choose>
        <c:when test="${not empty sessionScope.currentUser}">
          <span class="text-white">Xin chào <strong>${sessionScope.currentUser.fullname}</strong>!</span>
          <a class="btn btn-light ms-2" href="${pageContext.request.contextPath}/admin/signout" role="button">
            Đăng xuất
          </a>
        </c:when>
        <c:otherwise>
          <a class="btn btn-light" href="${pageContext.request.contextPath}/admin/signin" role="button">
            Đăng nhập
          </a>
        </c:otherwise>
      </c:choose>
