            ...
            <aside class="col-lg-3">
              ...
              <div class="card">
                <div class="card-body"><dl class="row mb-0">
                    ...
                    <dd class="col-6 text-end mb-3"><span id="temp-price">0</span>₫</dd>
                    <dt class="col-6">Phí vận chuyển:</dt>
                    <dd class="col-6 text-end mb-3"><span id="delivery-price">0</span>₫</dd>
                    <dt class="col-6">Tổng cộng:</dt>
                    <dd class="col-6 text-end mb-3"><strong><span id="total-price">0</span>₫</strong></dd>
                  </dl>
                </div> <!-- card-body.// -->
              </div> <!-- card.// -->
